...
btc_g_civs = ["vn_rdg2_mag", "vn_rgd5_grenade_mag", "vn_t67_grenade_mag"];


// ANIMALS
btc_animals_type = ["Hen_random_F", "Cock_random_F", "Fin_random_F", "Alsatian_Random_F", "Goat_random_F", "Sheep_random_F","vnx_waterbuffalo_01","Snake_vipera_random_F"];

//FOB
btc_fob_mat = "vn_us_komex_small_02";
btc_fob_structure = "Flag_Altis_F";
btc_fob_flag = "MapBoard_altis_F";
btc_fob_id = 0;
...
btc_type_divers = ["vn_o_men_vc_local_30","vn_o_men_vc_local_32","vn_o_men_vc_local_29"];                                                   // _allclasse select 2;
...
btc_flag_textures = [
    ...
    "\A3\Data_F\Flags\flag_Altis_CO.paa",
